...
@Module({
  imports: [JwtModule],
  providers: [CreateSpecieResolver, DeleteSpecieResolver, UpdateSpecieResolver, GetAllSpeciesResolver, GetSpecieResolver, PrismaService, SpecieMapper, ValidationsService]
})
